...
<template>
  <div class="city-scene-page" :class="{ 'preview-mode': props.previewMode }">
    <div v-if="isPlacementMode && !props.previewMode" class="placement-banner focus-hud-panel">
    ...
    <div v-if="selectedDecoration && !props.previewMode" class="selected-bar focus-hud-panel">
      <div>
